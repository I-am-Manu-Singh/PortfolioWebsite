                        ...
                        {resumeData.basics.profiles.map((profile, index) => (
                            ...
                            >
                                ...
                                {profile.network === 'LeetCode' && (
                                    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="text-current">
                                        <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.173 5.423l.025.022c-1.787.65-3.036 2.05-3.295 3.93.91.56 2.072 1.352 3.864 2.872l.482.352c.264-.78.78-1.5 1.585-2.076l5.242-4.104A1.373 1.373 0 0 0 13.483 0zm-2.062 6.56c-.05.138-.088.272-.125.404H11.3c-.004-.007-.01-.01-.013-.016l.006-.005a5.074 5.074 0 0 0-.087-.195l-.037-.082.02-.016a2.64 2.64 0 0 1 1.696-.826l.482.35a2.66 2.66 0 0 1 .496.06l-.946.74zm4.496.883l-.706.552c.62.596 1.05 1.464 1.05 2.508 0 1.056-.436 1.942-1.076 2.534l.69.54a4.42 4.42 0 0 0 1.503-3.074 4.416 4.416 0 0 0-1.46-3.06zm-7.652 3.6c-4.43 3.01-6.108 5.61-4.706 8.354 1.135 2.22 4.47 2.44 6.848.24l.02-.02 4.195-3.665a.687.687 0 0 0-.904-1.034l-4.184 3.655c-1.35 1.25-3.32.96-3.955.195-.49-.59-.512-1.744 1.488-3.76 1.38-1.39 3.036-2.6 4.965-3.626-2.11-.277-3.23.473-3.766.66z" />
                                    </svg>
                                )}
                            </motion.a>
                        ))}
